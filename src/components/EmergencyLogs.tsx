        ...
        <div className="p-6">
          <div className="flex justify-between items-center mb-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h2 className="text-2xl font-bold text-gray-900">Emergency Response Logs</h2>
                <p className="text-gray-600">Track all emergency actions and responses</p>
              </div>
            </div>
          ...
          {logs.length === 0 ? (
            <div className="text-center py-12">
              ...
              <h3 className="text-lg font-semibold text-gray-600 mb-2">No Emergency Logs</h3>
              <p className="text-gray-500">Emergency actions will appear here when triggered</p>
            </div>
          ) : (
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-4">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-sm font-semibold text-blue-700">{log.zone}</span>
                        </div>
                      </div>
                      <div className="flex items-center space-x-2">
          ...
          <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <div className="flex items-center space-x-2 mb-2">
              ...
              <h3 className="font-semibold text-blue-800">Log Information</h3>
            </div>
